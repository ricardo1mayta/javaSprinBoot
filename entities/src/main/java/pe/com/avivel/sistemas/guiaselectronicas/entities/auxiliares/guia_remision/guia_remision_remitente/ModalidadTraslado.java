...
@Entity
@Table(name = "grr_modalidad_traslado")
//@SQLDelete(sql = "UPDATE grr_modalidad_traslado SET deleted = true, fecha_eliminacion = CURRENT_TIMESTAMP  WHERE id=?")
//@Where(clause = "deleted = 0")
public class ModalidadTraslado extends Auditable implements Serializable {

    private static final long serialVersionUID = 8122113437236845274L;
